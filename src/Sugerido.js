...
const API_URL = "http://146.190.75.181:5000/api/sugerido";
...
export default function Invcoopi() {
  ...
  const columns = [
    ...
    { key: "bod", header: "Cod Bod" },
    { key: "stock", header: "Stock" },
    { key: "rot30", header: "Rot 30" },
    { key: "clasificacion", header: "Clasificacion" },
    { key: "sugerido", header: "Q Sugerido" },
    { key: "diascobertura", header: "Dias Cobertura" },
    { key: "estado", header: "Estado" },
    { key: "coopi", header: "Inv Coopi" },
  ];
  ...
  return React.createElement(
    ...
    React.createElement(DataTable, {
      ...
      columns,
      pageSize: 10,
      exportFileName: "sugeridopedido.xlsx",
      fetchOptions: {
        headers: {
